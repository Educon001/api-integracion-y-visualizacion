...
(
    ...
    CONSTRAINT fk_hecho_vehiculo FOREIGN KEY (id_vehiculo) references vehiculo (id_modelo),
    CONSTRAINT fk_hecho_metodo_pago FOREIGN KEY (id_metodo_pago) references metodo_pago (id_metodo),
